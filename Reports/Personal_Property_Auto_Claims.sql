WITH CLAIM_DATA AS (
            ...
            (
             ...
             -- CD.CLAIM_KEY,
              ...
              PC.AGENCYDOMICILESTATE AS DOMICILE_STATE,
              CD.CLAIM_NBR,
              CD.DATE_OF_LOSS,
              CD.CAUSE_NAME,
              CD.CLAIM_STATUS,
              ...
              THEN NVL(CLT.LOSS_PAID,0)+NVL(CLT.UNALLOC_EXPENSE_PAID,0)+NVL(CLT.ALLOC_EXPENSE_PAID,0)
              ELSE 
              ...
              (max(nvl(CD.FAULT,0))) AS "%_AT_FAULT",
              PC.UNDERWRITER ,
              ...
              CLT.DATE_RSRVE_CHNGED, CD.FAULT, PC.UNDERWRITER, CRU.CRU_INDICATOR
            )
           SELECT * FROM CLAIM;