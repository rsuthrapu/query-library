...
select
       ...
       P.NAME AS KEY_ACCOUNT_NAME,
        ...
        ASL.A_S_LINE_NBR,
        '' as COVERAGE, --   C.COVERAGE_DESC AS COVERAGE, -- to do
       case 
        --  when lower(C.coverage_desc) like '%liability%' then 'Liability' -- to do
        --  when C.coverage_desc like 'Boiler '|| chr(38) ||' Machinery' then 'Boiler Machinery' -- to do
...
CMS_DATA_WITH_INCURRED_LOSS AS (
...
--          else 'NOT MATCHED'
--        end
FROM CMS_DATA_WITH_INCURRED_LOSS CD
