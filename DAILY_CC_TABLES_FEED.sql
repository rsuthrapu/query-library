...
INSERT INTO DLAKEDEV.D_CCX_MIRREPORTABLEHIST_ACCMIT
SELECT T.* , TRUNC(SYSDATE)-1 AS LOAD_DATE, 'CC' AS CLAIM_SOURCE FROM CCX_MIRREPORTABLEHIST_ACCMIT@CIGDW_TO_CC_QA_LINK T
WHERE TRUNC(UPDATETIME) > TRUNC(SYSDATE)-2 AND TRUNC(UPDATETIME) < TRUNC(SYSDATE);
...
INSERT INTO DLAKEDEV.DAILY_CCTL_PAYMENTMETHOD
SELECT T.* , TRUNC(SYSDATE)-1 AS LOAD_DATE, 'CC' AS CLAIM_SOURCE FROM CCTL_PAYMENTMETHOD@CIGDW_TO_CC_QA_LINK T;
 
INSERT INTO DLAKEDEV.DAILY_CCTL_PAYMENTTYPE
SELECT T.* , TRUNC(SYSDATE)-1 AS LOAD_DATE, 'CC' AS CLAIM_SOURCE FROM CCTL_PAYMENTTYPE@CIGDW_TO_CC_QA_LINK T';
