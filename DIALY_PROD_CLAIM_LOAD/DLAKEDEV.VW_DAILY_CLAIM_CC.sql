...
"CATASTROPHE", "BRANCH", "ATTORNEY", "POLICY", "UNIT_KEY", "DATE_OF_LOSS", "CLAIM_STATUS", "CLAIM_STATUS_DATE", "STAFF", "CLAIM_DESC",
"LOCATION", "CITY", "STATE", "COUNTY", "COUNTRY", "SUIT_TYPE", "SUIT_REASON", "COURT", "LAWSUIT_STATUS", "LAWSUIT_STATUS_DATE", 
"CUMIS_COUNCIL", "RESOLUTION_METHOD", "RESOLUTION_AMT", "REINS_REASON", "REINS_REPORTED", "REINS_BILL_STATUS", "REINS_TYPE", "REINS_YEAR",
"DRIVER", "AT_FAULT", "DATE_LETTER_SENT_TO", "CREATE_ID", "FIRST_MODIFIED", "AUDIT_ID", "LAST_MODIFIED", "DEFENSE_FIRM", "OCCUR",
"PAF_LETTER", "PAF2", "PAF_SENT", "PAF_RESCINDED", "NOT_OUR_VEHICLE", "PARKED", "DRIVER_NOT_LISTED", "PAF_REASON", "TABLE_NAME", 
"DOING_BUSINESS_AS", "PERIL_TYPE", "CLAIM_ASSIGNMENT_FLAG", "CLAIM_TITLE", "RECOVERY_STRATEGY", "CLOSING_DATE", "BATCH_NUMBER", 
"RENTALCAR_PICKUP_DT", "CLAIM_FOLDER", "FAULT_TYPE", "VEHICLE_MOVEOUT_DT", "CURNIS_COUNCIL", "CLAIM_PREFIX", "OFFER_REFER_NUMBER",
"ACCIDENT_FAULT", "SUITE", "ZIP_CODE", "RENTALCAR_AUTH_DT", "RESERVE_MEMO_STATUS", "IDEMNITY_PORTION", "PAF_EXCEPTION", "PAF", 
"ORIGINATE_DATE", "INCOMING", "SOURCE", "ACP_NAME", "DEDUCTIBLE_AMOUNT", "CLAIM_EVENT_TIME", "AUTORIZATION_LEVEL", "VEHICLE_MOVEIN_DT",
"DUAL_COVERAGE", "REASON", "UNIT_NBR", "OUTGOING_PAYMENTS", "REJECT_CLAIM_COMMENTS", "CLAIM_NUMBER", "CALLCODE", "ACCEPT_CLAIM", 
"PAF2_LETTER", "RENTALCAR_RETURN_DT", "PAF1_LETTER", "SETTLEMENT_CURRENCY_SELECTION", "CMS_ISO_POLICY_TYPE", "LOCATION_CODE",
"CLAIM_REMARKS", "CAT_LOSS_DESC", "LOAD_DATE") AS 
SELECT C.ID AS CLAIM,
    ...
    '' AS LOCATION_CODE,'' AS CLAIM_REMARKS,'' AS CAT_LOSS_DESC,'' AS IS_RQY,SYSDATE AS LOAD_DATE
