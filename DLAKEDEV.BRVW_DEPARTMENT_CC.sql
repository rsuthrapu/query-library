--------------------------------------------------------
--  DDL for View BRVW_DEPARTMENT_CC
--------------------------------------------------------
 

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DLAKEDEV"."BRVW_DEPARTMENT_CC" ("DEPT", "DEPARTMENT_NUMBER", "DEPARTMENT_NAME", "BUSINESS_LINE", "BUSINESS_LINE_NAME", "MAJOR_LINE", "MAJOR_LINE_NAME", "CORE_LINE_OF_BUSINESS","CLAIM_SOURCE") AS 
  SELECT dept.dept,
